  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="generate.fitness privacy policy"
      ...
      <div style={{ padding: "2rem" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to generate.fitness.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to generate.fitness, accessible
              from{" "}
              <a
        ...
        <ul>
          <li>By email: hi@generate.fitness</li>
        </ul>
      </div>
    </>
  );
