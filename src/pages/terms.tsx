  ...
  return (
    <>
      <Head>
        <title>Terms</title>
        <meta
          name="generate.fitness terms and conditions"
          content="Fitness planning app"
        />
      ...
      <div style={{ padding: "2rem" }}>
        ...
        <p>
          ...
          use of generate.fitness's Website, located at
          https://generate.fitness.
        </p>
        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use generate.fitness if you do not
          agree to take all of the terms and conditions stated on this page.
        </p>
        <h2>Cookies</h2>
        <p>
          The website uses cookies to help personalize your online experience.
          By accessing generate.fitness, you agreed to use the required cookies.
        </p>
        <p>
          A cookie is a text file that is placed on your hard disk by a web page
          server. Cookies are uniquely assigned to you and can only be read by a
          web server in the domain that issued the cookie to you.
        </p>
        <p>
          We may use cookies to collect, store, and track information for
          statistical or marketing purposes to operate our website. There are
          some required Cookies that are necessary for the operation of our
          website. These cookies do not require your consent as they always
          work. Please keep in mind that by accepting required Cookies, you also
          accept third-party Cookies, which might be used via third-party
        ...
        <p>
          ...
          generate.fitness does not filter, edit, publish or review Comments
          before their presence on the website. Comments do not reflect the
          views and opinions of generate.fitness, its agents, and/or affiliates.
          ...
          generate.fitness shall not be liable for the Comments or any
        ...
        <p>
          generate.fitness reserves the right to monitor all Comments and remove
